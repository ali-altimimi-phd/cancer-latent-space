...
class LatentRuntimeConfig:
    ...
    filter_regime: str = "variance_global"
    top_n: int = 3000
    random_seed: int = 42
    ...
    def output_dir(self) -> Path:
        return self.project_dir / "output" / "global_cancer" / "structural_inference"
    ...
    def expression_filename(self) -> str:
        return f"{self.chip_id}_expr_top{self.top_n}_{self.filter_regime}.csv"
    ...
    def features_filename(self) -> str:
        return f"{self.chip_id}_top{self.top_n}_{self.filter_regime}_features.csv"
